...
function formular_3(){
    ...
    var param2 = +document.getElementById("param_3-2").value;           // M > 0 (M > 0.3) => 0 < M < 5
...
function formular_4(){
    ...
    var param2 = +document.getElementById("param_4-2").value;       //M1 > 1 ( > 1.8)
    var param3 = +document.getElementById("param_4-3").value;       //0 < Thetaa < 90
    ...
    if(param1 > 1 && param1 <= 2 && param2 > 1.8 && param3 > 0 && param3 < 90){
...
function formular_5(){
    ...
    var param2 = +document.getElementById("param_5-2").value;       //M1 > 1 ( > 1.8)
    var param3 = +document.getElementById("param_5-3").value;       //0 < Thetaa < 90

    if(param1 <= 1 || param1 > 2){
        document.getElementById("valid_5-1").style.display = "block";
    }else{
        document.getElementById("valid_5-1").style.display = "none";
    }

    if(param2 <= 1){
        document.getElementById("valid_5-2").style.display = "block";
    }else{
        document.getElementById("valid_5-2").style.display = "none";
    }

    if(param3 <= 0 || param3 >= 90){
        document.getElementById("valid_5-3").style.display = "block";
    }else{
